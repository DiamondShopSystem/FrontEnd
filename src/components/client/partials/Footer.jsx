            ...
            <Container fluid className="footer__container">
                <Row className="p-4 footer__content">
                    ...
                    <Col>
                        ...
                        <a href="#"><i><img className="payment-icon" alt="img-mail" src="https://cdn.haitrieu.com/wp-content/uploads/2022/10/Logo-MoMo-Circle.png" /></i></a>
                        <a href="#"><i><img className="payment-icon" alt="img-mail" src="https://cdn.haitrieu.com/wp-content/uploads/2022/10/Logo-ZaloPay-Square.png" /></i></a>
                    </Col>
                    <Col>
                        ...
                        <div className="social-icons">
                            <a href="#"><i><img alt="img-fb" src="	https://cdn.pnj.io/images/image-update/footer/facebook.svg" /></i></a>
                            <a href="#"><i><img alt="img-ins" src="https://cdn.pnj.io/images/image-update/footer/instagram.svg" /></i></a>
                            <a href="#"><i><img alt="img-ytb" src="	https://cdn.pnj.io/images/image-update/footer/youtube.svg" /></i></a>
                            <a href="#"><i><img alt="img-mail" src="https://cdn.pnj.io/images/image-update/footer/email.svg" /></i></a>
                        </div>
                        <h4>Chứng nhận</h4>
                        <a href="#"><i><img
                            style={{ marginLeft: '16px', maxWidth: '130px', height: 'auto' }}
                            alt="img-mail"
                            src="https://cdn.pnj.io/images/image-update/op-da-thong-bao-bo-cong-thuong-183x60.png" /></i></a>
                    </Col>
                </Row>
