    ...
    return (
        <>
            ...
            <Container>
                ...
                <div style={{ marginTop: '20px' }}><h2>Hướng dẫn đo size dây chuyền, dây cổ và kiềng</h2></div>
                <div className="sizeBracelet__guide">
                    <div className="table-of-contents">
                        <h2>Nội dung bài viết</h2>
                        <ul>
                            <li><a href="#section1">1. Tại sao lại cần phải đo size dây chuyền, dây cổ và kiềng?</a></li>
                            <li><a href="#section2">2. Cách cách đo size dây chuyền, dây cổ và kiềng</a>
                                <ul>
                                    <li><a href="#section2-1">2.1. Dùng thước dây chuyền, dây cổ và kiềng có sẵn</a></li>
                                    <li><a href="#section2-2">2.2. Đo thủ công</a></li>
                                </ul>
                            </li>
                            <li><a href="#section3">3. Một số độ dài dây chuyền trên cổ thông thường</a></li>
                            <li><a href="#section3">4. Những lưu ý khi mua dây chuyền, vòng cổ</a></li>
                            <li><a href="#section4">5. Kết luận</a></li>
                        </ul>
                    </div>
                    <div className="product-section" id="section1">
                        <h2>Tại sao lại cần phải đo size lắc, vòng tay?</h2>
                        <p>Độ dài dây chuyền phù hợp giúp bạn thoải mái khi đeo và thoả sức layer với các kiểu dáng khác nhau. Lý tưởng nhất là bạn hãy đến Store để đo và thử trực tiếp, nếu không bạn có thể tham khảo cách đo size dây chuyền tại nhà theo hướng dẫn đơn giản dưới đây.</p>
                    </div>
...
export default SizeNecklaceGuide;