        ...
        <div className="details-footer">
            <div className="footer-section">
                <div className="commitment">
                    <h4>
                        <img src="https://theme.hstatic.net/1000381168/1000941305/14/titlebottomuudaiicon1.png?v=604" alt="Commitment Icon" /> CAM KẾT CHẤT LƯỢNG
                    </h4>
                    <ul>
                ...
                <div className="guide">
                    <h4>
                        <img src="https://theme.hstatic.net/1000381168/1000941305/14/titlebottomuudaiicon2.png?v=604" alt="Guide Icon" /> HƯỚNG DẪN MUA HÀNG ONLINE
                    </h4>
                    <ul>
                        <li>Quý Khách vào trang sản phẩm để xem các sản phẩm được đăng tải trên Website.</li>
